...
<%	'**************************************************************************
	...
	mailComp   = "CDOSYS"
	smtpServer = "smtp.truenet.com"
	fromAddr   = "jdavidson@blueprintstudiosllc.com"

	allowedHosts      = Array("www.blueprintstudiosllc.com", "blueprintstudiosllc.com")
	allowedRecipients = Array("jdavidson@blueprintstudiosllc.com")
...
<% if UBound(errorMsgs) < 0 then %>
<meta http-equiv="Refresh" content="0; url= http://www.blueprintstudiosllc.com/page.aspx?page=contact_thanks" /> 
<% end if %>
</head>
<body>
<%	if UBound(errorMsgs) >= 0 then %>
